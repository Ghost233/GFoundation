...
#define _GTMDevAssert(condition, ...)                                                                                                                                                                                    \
    do {                                                                                                                                                                                                                 \
        if (!(condition)) {                                                                                                                                                                                              \
            [[NSAssertionHandler currentHandler] handleFailureInFunction:[NSString stringWithUTF8String:__PRETTY_FUNCTION__] file:[NSString stringWithUTF8String:__FILE__] lineNumber:__LINE__ description:__VA_ARGS__]; \
        }                                                                                                                                                                                                                \
    } while (0)
...
#else
#define GTM_FOREACH_OBJECT(element, collection) for (NSEnumerator* _##element##_enum = [collection objectEnumerator]; (element = [_##element##_enum nextObject]) != nil;)
#define GTM_FOREACH_KEY(element, collection) for (NSEnumerator* _##element##_enum = [collection keyEnumerator]; (element = [_##element##_enum nextObject]) != nil;)
#endif
#endif
